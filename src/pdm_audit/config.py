...
class Config:
    ...
    def use_hook(self) -> "bool":
        return Config._str_to_bool(
            self.__project.config[self.config_names.use_hook],
            self.config_items.use_hook.default,
        )

    @property
    def hook_verbose(self) -> "bool":
        return Config._str_to_bool(
            self.__project.config[self.config_names.hook_verbose],
            self.config_items.hook_verbose.default,
        )

    @property
    def repeatable(self) -> "bool":
        return Config._str_to_bool(
            self.__project.config[self.config_names.repeatable],
            self.config_items.repeatable.default,
        )
